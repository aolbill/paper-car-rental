...
const HeroSearchForm = () => {
  ...
  const [searchData, setSearchData] = useState({
    ...
    carType: 'all',
    vehicleModel: '',
    searchType: 'location' // 'location' or 'model'
  })
  const [searchMode, setSearchMode] = useState('quick') // 'quick' or 'advanced'
  ...
  const getMinDropoffDate = () => {
    if (searchData.pickupDate) {
      ...
      pickupDate.setDate(pickupDate.getDate() + 1) // Minimum 1 day rental
